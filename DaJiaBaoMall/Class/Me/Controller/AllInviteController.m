...
@interface AllInviteController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation AllInviteController
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"我的邀请-所有邀请"];
}
/**
 *  友盟统计页面关闭时间
 *
...
- (void)viewWillDisappear:(BOOL)animated{
    ...
    [MobClick endLogPageView:@"我的邀请-所有邀请"];
}
