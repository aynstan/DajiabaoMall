...
@interface AlreadyPayController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation AlreadyPayController
...
- (void)addMJheader{
    MJHeader *mjHeader=[MJHeader headerWithRefreshingBlock:^{
        NSString *url=[NSString stringWithFormat:@"%@%@",APPHOSTURL,alreadyPay];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"我的订单-已支付"];
}
/**
 *  友盟统计页面关闭时间
 *
...
- (void)viewWillDisappear:(BOOL)animated{
    ...
    [MobClick endLogPageView:@"我的订单-已支付"];
}
