...
@interface LoadPayController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation LoadPayController
...
- (void)addMJheader{
    MJHeader *mjHeader=[MJHeader headerWithRefreshingBlock:^{
        NSString *url=[NSString stringWithFormat:@"%@%@",APPHOSTURL,loadPay];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"我的订单-待支付"];
}
/**
 *  友盟统计页面关闭时间
 *
...
- (void)viewWillDisappear:(BOOL)animated{
    ...
    [MobClick endLogPageView:@"我的订单-待支付"];
}
