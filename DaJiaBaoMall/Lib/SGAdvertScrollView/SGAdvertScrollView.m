...
static CGFloat const SGMargin = 20;
...
- (void)layoutSubviews {
    ...
    // 设置图片尺寸
    CGFloat imageViewX = 12;
    CGFloat imageViewY = (self.frame.size.height-30)/2.0;
    _imageView.frame = CGRectMake(imageViewX, imageViewY, 30, 30);
    
    // 设置 collectionView 尺寸
    CGFloat collectionViewX = CGRectGetMaxX(_imageView.frame) + 5;
